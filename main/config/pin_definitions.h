...
#define FLEX_SENSOR_MIDDLE_ADC_CHANNEL     ADC_CHANNEL_2   // GPIO3
#define FLEX_SENSOR_RING_ADC_CHANNEL       ADC_CHANNEL_3   // GPIO4
#define FLEX_SENSOR_PINKY_ADC_CHANNEL      ADC_CHANNEL_4   // GPIO5
